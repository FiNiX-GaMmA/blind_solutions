...
4. **Array multiplication without itself**
  > **Method 1 -** for this i took the array made a product of all the elements and i divided the current element from the product to get the multiplication without the current numbers. Method 2 - finding an optimal solution in process
5. **Maximum sub array :-**
  > **Method 1 -**  